    ...
    public partial class SeedingDataForDifficultiesandRegions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("14996384-c9d1-4a6b-b8a6-2eb7aff7af08"), "Medium" },
                    { new Guid("5da88fdc-1d37-45fd-94fd-fbca7fe96be6"), "Hard" },
                    { new Guid("a5ed43de-ff5a-4849-a958-aafe58c4abf6"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("14996384-c9d1-4a6b-b8a6-2eb7aff7af08"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("5da88fdc-1d37-45fd-94fd-fbca7fe96be6"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("a5ed43de-ff5a-4849-a958-aafe58c4abf6"));
